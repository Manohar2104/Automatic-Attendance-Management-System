...
object BleConstants {
    ...
    const val ACTION_START_ADVERTISING = "com.smartattendance.action.START_BLE_ADVERTISING"
    const val ACTION_STOP_ADVERTISING = "com.smartattendance.action.STOP_BLE_ADVERTISING"
